...
const createButton = document.querySelector("#create-a-room");
const videoCont = document.querySelector('.video-my');
const codeCont = document.querySelector('#joinroomcode');
const joinBut = document.querySelector('#joinit');
...
createButton.addEventListener('click', (e) => {
    ...
    createButton.classList = 'create-a-room-clicked';
...
joinBut.addEventListener('click', (e) => {
    ...
    if (codeCont.value.trim() == "") {
        codeCont.classList.add('joinroomcode-error');
        return;
    }
...
codeCont.addEventListener('change', (e) => {
    e.preventDefault();
    if (codeCont.value.trim() !== "") {
        codeCont.classList.remove('joinroomcode-error');
        return;
    }
})
