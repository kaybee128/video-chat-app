...
// }
// const socket = io("/");
// const vidBOX = document.getElementById("vc-box");
...
// });
// var Peer_ID;
// constuserVid = document.queryselector("#vd1");
// myVideo.muted = true;
// varuserVidStream;
// varuserVidTrack;
// const peers = {};
...
//             })
//             .then((stream) => {
//                userVidStream = stream;
//                userVidTrack = stream.getVideoTracks()[0];
...
//     addVideoStream(myVideo,userVidStream, null, {
//         name: name,
//         audio:userVidStream.getAudioTracks()[0].enabled,
//         video:userVidStream.getVideoTracks()[0].enabled,
//     });
...
//         connectToNewUser(userId,userVidStream);
//         changeCount(count);
//     });
// }
// myPeer.on("open", (id) => {
...
//            userVidTrack =userVidStream.getVideoTracks()[0];
...
//     }
//     replaceVideoTrack(myVideoStream,userVidTrack);
// };
...
//     let enabled =userVidStream.getVideoTracks()[0].enabled;
//     const currentElement = e.target;
//     if (enabled) {
//        userVidStream.getVideoTracks()[0].enabled = false;
...
//     } else {
//        userVidStream.getVideoTracks()[0].enabled = true;
...
//     const enabled =userVidStream.getAudioTracks()[0].enabled;
//     const currentElement = e.target;
//     if (enabled) {
//         socket.emit("audio-toggle", false);
//         videoWrapperMicToggle(myVideo, false);
//        userVidStream.getAudioTracks()[0].enabled = false;
...
//        userVidStream.getAudioTracks()[0].enabled = true;
...
//             USER_ID,
//             name,
//            userVidStream.getAudioTracks()[0].enabled,
//            userVidStream.getVideoTracks()[0].enabled
//         );
...
//         track.stop();
//     });
//    userVid.classList.toggle("mirror");
...
//        userVid.previousSibling.appendChild(recordingElement);
//         // recording
